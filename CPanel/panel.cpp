...
void panel::supOutputGeom(const Eigen::Vector3d &POI, bool outPOI)
{
	std::ofstream fid;
	std::string	myFile = "D:\\Desktop\\Thesis\\Code\\MATLAB\\Subsonic\\stuff.csv";
	fid.open(myFile);
